...
const workExperience = [
  {
    ...
    items: [
      'Lead globally distributed team of 12 DevOps engineers supporting 500+ developers; standardize metadata-driven and GitOps practices across software development lifecycle.',
      'Drive platform strategy and architectural decisions; align infrastructure with business priorities.',
      'Architected disaster recovery and failover automation for Jenkins CI/CD infrastructure; coordinated practices for organizational continuity.',
      'Led migration from on-premises RHEV to AWS EKS, modernizing infrastructure and enabling cloud-native deployment patterns at scale.',
      'Drove post-acquisition integration of SquareTrade CI/CD platform into Allstate engineering organization; rewrote shared pipeline libraries to align with Allstate infrastructure while standardizing practices.',
      'Led migration from GitHub Enterprise on-premises to GitHub SaaS; implemented configuration as code for GitHub organization and repository management.',
      'Designed custom GitFlow with automated enforcement; established standards for pipeline code, IaC, and automation.',
      'Supported monolith to microservices migration; established infrastructure patterns for safe team adoption.',
      'Evaluating agentic AI infrastructure patterns including LLM cost controls, token observability, and safe deployment standards for engineering organization adoption.',
    ]
  },
  {
    ...
    items: [
      'Architected and drove adoption of GitOps workflows and Infrastructure as Code standards across the organization.',
      'Designed and implemented CloudBees CI platform and automation code; established release process, branching standards, and cloud-native practices; integrated artifact repositories and security scanning to prepare for infrastructure migration.',
      'Optimized Liquibase database schema automation to improve reliability and consistency of database deployments across environments.',
      'Provided technical leadership on complex software, platform, and release engineering issues organization-wide; mentored teams and drove resolution of critical infrastructure blockers.',
    ]
  },
  {
    ...
    items: [
      ...
      'Architected serverless and containerized solutions leveraging AWS managed services and Kubernetes.',
    ]
  },
  {
